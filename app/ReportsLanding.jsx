...
const REPORTS = [
  ...
  { id: 5, name: "The Spiritual Entrepreneur", sigil: "entrepreneur", tier: "standard", price: 79, desc: "Sacred Commerce Profiles — ancestral commerce lineages, soul-aligned revenue, sacred business architecture.", focus: "Ancestral commerce lineages · Soul-aligned revenue · Sacred business architecture · The oracle within the founder" },
  ...
  { id: 7, name: "Attachment Bonds", sigil: "attachment", tier: "standard", price: 79, desc: "Your Love Architecture — attachment forensics, toxic cycle breaking, twin flame mapping, bond alchemy & repair.", focus: "Attachment architecture · Toxic cycle breaking · Twin flame mapping · Bond alchemy & repair" },
  ...
  { id: 12, name: "The Calling", sigil: "calling", tier: "standard", price: 79, desc: "Sacred Gifts & Prophetic Identity — spiritual gift forensics, prophetic identity mapping, divine assignment, anointing architecture.", focus: "Spiritual gift forensics · Prophetic identity mapping · Divine assignment · Anointing architecture" },
];

const LIVE_ROUTES = { 1: "/bloodline", 2: "/dream-atlas", 3: "/lovers", 5: "/spiritual-entrepreneur", 6: "/desire", 7: "/attachment-bonds", 8: "/financial", 9: "/rage", 10: "/sirens-call", 11: "/past-lives", 12: "/the-calling" };
